                        ...
                        <v-layout row>
                          <v-flex xs12>
                            <v-list>
                              <v-list-tile>
                                <v-list-tile-content>
                                  <v-list-tile-title>Lorem ipsum is placeholder text commonly used</v-list-tile-title>
                                  <v-list-tile-sub-title>
                                    ...
                                    <!-- <span>
                                      <div style="border: 1px solid #C1D9E8; height:4px; width: 4px; border-radius:4px; display:inline-block"></div>
                                    </span> -->
